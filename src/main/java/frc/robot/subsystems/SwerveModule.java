...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants, boolean invertedDrive, boolean invertedSteer){
        ...
        configAngleMotor();
        mAngleMotor.setInverted(invertedSteer);
        


        mDriveMotor = new TalonFX(moduleConstants.driveMotorID);
        configDriveMotor();
        mDriveMotor.setInverted(invertedDrive);
