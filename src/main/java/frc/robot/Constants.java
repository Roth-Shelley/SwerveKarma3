...
//++, +-, -+, --    FAIL
        ...
        public static final class Mod0 {
            ...
            public static final double angleOffset = 128.144;
            public static final boolean invertedDrive = true;
            public static final boolean invertedSteer = false;
        ...
        public static final class Mod1 {
            ...
            public static final double angleOffset = 112.76;
        ...
        public static final class Mod2 {
            ...
            public static final double angleOffset = 55.547;
            public static final boolean invertedDrive = true;
             public static final boolean invertedSteer = false;
            public static final SwerveModuleConstants constants = 
                new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        ...
        public static final class Mod3 {
            ...
            public static final double angleOffset = 257.959;
            public static final boolean invertedDrive = true;
            public static final boolean invertedSteer = false;
            public static final SwerveModuleConstants constants = 
            new SwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
    ...
    public static final class Shooter{
        ...
        public final static int pivotMotor1ID = 0;
        public final static int pivotMotor2ID = 0;
